...
#define TIZEN_PATH   ".tizen"
#define SDB_KEY_FILE   "sdbkey"
...
static int get_user_keyfilepath(char *filename, size_t len) {
	...
	if (snprintf(android_dir, sizeof(android_dir), format, home, TIZEN_PATH)
			>= (int) sizeof(android_dir))
		return -1;
	...
	return snprintf(filename, len, format, android_dir, SDB_KEY_FILE);
}
